            ...
            <table class="table table-striped table-success">
                ...
                <c:forEach var="branch" items="${branches}">
                    <tr>
                        ...
                        <td>
                            <c:out value="${branch.branchAddress}"/>
                        </td>
                        <td>
                            <c:out value="${branch.branchPhoneNumber}"/>
                        </td>
                        <td>
                            <form action="${pageContext.request.contextPath}/branch" method="get">
                                <input type="hidden" name="action" value="show view update branch">
                                <input type="hidden" name="branchId" value="${branch.id}">
                                <button type="submit">Update</button>
                            </form>
                        </td>
                        <td>
                            <form action="${pageContext.request.contextPath}/branch" method="post">
                                <input type="hidden" name="action" value="delete branch">
                                <input type="hidden" name="branchId" value="${branch.id}">
                        ...
                        <td>
                            <form action="${pageContext.request.contextPath}/branch" method="get">
                                <input type="hidden" name="action" value="show view add branch">
