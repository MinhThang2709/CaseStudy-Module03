...
<div class="container">
    ...
    <div class="main">
        <nav class="navbar">
            <span class="navbar__name">Le Gia Minh Thang</span>
            ...
            <table class="table table-striped table-success">
                ...
                <c:forEach var="transaction" items="${transactions}">
                    <tr>
                        ...
                        <td>
                            <c:out value="${transaction.balanceAfterTransaction}"/>
                        </td>
                        <td>
                            <c:out value="${transaction.transactionTime}"/>
                        </td>
                        <td>
                            <c:out value="${transaction.address}"/>
                        </td>

                        <td>
                            <form action="${pageContext.request.contextPath}/transaction" method="get">
                                <input type="hidden" name="action" value="show view update transaction">
                        ...
                        <td>
                            <form action="${pageContext.request.contextPath}/transaction" method="get">
                                <input type="hidden" name="action" value="show view add transaction">
