            ...
            <table class="table table-striped table-success">
                ...
                <c:forEach var="account" items="${accounts}">
                    <tr>
                        ...
                        <td>
                            <c:out value="${account.accountOpeningDate}"/>
                        </td>
                        <td>
                            <c:out value="${account.accountTerm}"/>
                        </td>
                        <td>
                            <form action="${pageContext.request.contextPath}/account" method="get">
                                <input type="hidden" name="action" value="show view update account">
                        ...
                        <td>
                            <form action="${pageContext.request.contextPath}/account" method="get">
                                <input type="hidden" name="action" value="show view add account">
